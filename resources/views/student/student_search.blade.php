...
<div id="logo">
    <a href="{{ route('student_view_courses') }}"><button class="button button2" type="button">Course</button></a>
    <a href="{{ route('student_view_faculties') }}"><button class="button button2" type="button">Faculty</button></a>
</div>
