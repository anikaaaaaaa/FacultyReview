...
<div class="center-table" style="margin-top: 100px">
    <table>
        <thead>
            <tr>
                <th><h2><strong>All Departments</strong></h2></th>
            </tr>
        </thead>
        <tbody>
            @foreach($departments as $department)
            <tr>
            <td class="table-cell-beautify" style="font-size: 22px"><a href="{{ route('show_department_info', $department->id ) }}">{{ $department->dept_name }}</a></td>
            </tr>
            @endforeach
        </tbody>
    </table>
