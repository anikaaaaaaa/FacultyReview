...
<div>
    <nav>
        ...
        <h3><strong>Faculty Request Form by {{ $student->name }}</strong></h3>
    </nav>
</div>
<div class="customDiv">
    <form method="POST" action="{{ route('student_create_faculty') }}">
    @csrf
        <div>
        ...
        <div>
            ...
            <input id="initial" type="text" name="initial" value="" required>
        </div>

        <div>
            <label for="bio">Bio:</label>
            <input id="bio" type="textarea" name="bio" value="" required>
        </div>
        ...
        <input id="user_id" type="hidden" name="user_id" value="{{ $student->id }}" required>
        ...
        <div>
            <button type="submit" style="background-color: #007bff; color: #ffffff; border: none; padding: 10px 20px; border-radius: 5px; cursor: pointer;">Add Faculty</button>
        </div>
    </form>
</div>
</body>
