...
<div class="center-table" style="margin-top: 100px">
    <table>
        <thead>
            <tr>
                <th><h2><strong>All Department courses of {{ $department->dept_name }} ({{ $department->abbr_name }})</strong></h2></th>
            </tr>
        </thead>
        <tbody>
            @foreach($courses as $course)
            <tr>
                <td class="table-cell-beautify" style="font-size: 22px"><a href="#">{{ $course->course_name }}</a></td>
            </tr>
            @endforeach
        </tbody>
    </table>
